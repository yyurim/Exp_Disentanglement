...
for epoch in range(epochs+1):
    ...
    train_loader = dm.feat_loader_pair(SP_DICT_TRAIN, batch_size, shuffle=True, ppg_dict=PPG_DICT_TRAIN)
    ...
    dev_loader = dm.feat_loader_pair(SP_DICT_DEV, batch_size, shuffle=True, ppg_dict=PPG_DICT_DEV)
